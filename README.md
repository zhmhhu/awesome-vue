...
- [资源](#resources)
    ...
    - [例子](#examples)
    - [图书](#books)
- [使用 Vue.js 的项目](#projects-using-vuejs)
  - [开源项目](#open-source)
  - [商业产品](#commercial-products)
  - [App/网站](#appswebsites)
  - [互动体验](#interactive-experiences)
  - [企业用法](#enterprise-usage)
- [组件和库](#components--libraries)
  ...
  - [框架](#frameworks)
    - [响应式框架](#responsive)
    - [移动框架](#mobile)
    - [组件集合](#component-collections)
    - [管理模板](#admin-template)
    - [其他](#other)
  - [UI 实用程序](#ui-utilities)
    - [事件处理](#event-handling)
...
- [Vue.js資料まとめ(for japanese)](https://gist.github.com/hashrock/f575928d0e109ace9ad0) 作者 @hashrock
- [Vue.js Newsletter](http://vue-newsletter.com/) - 每周精心挑选的 Vue.js 新闻
- [Vue.js Tips](http://vuetips.com) - 成为更好的Vue.js开发者的有关提示
- [Vue.js Wikipedia](https://en.wikipedia.org/wiki/Vue.js)
- [Vue.js Radar](https://www.vuejsradar.com) —— 
包含新的Vue.js版本发行/贡献的精选资讯和网站。


### Job Portal

- [Vue.js Jobs - VueJobs](https://vuejobs.com/) —— 一个可为您提供所有与 Vue.js 相关的求职和应聘机会的求职门户。
...
请求您想要的已存在的Vue.js模块或获取模块的建议
- [VueJS Iran - Telegram 频道和群组（在频道页中可以获取群组链接）](https://telegram.me/vue_js)
- [vueslack —— 全世界有超过2300的注册用户](https://vueslack.slack.com/)
- [Vue Land —— 嘈杂的聊天服务](https://vue-land.js.org/)
- [VueJS Russia - Telegram 群组[俄罗斯]](https://t.me/vuejs_ru)
- [VueJS Viet Nam - Facebook 群租](https://www.facebook.com/groups/vuejsvietnam/)
- [VueJS Spanish - Slack 群租](https://slack.vue-es.org/)
- [VueJS Korean - Slack 群租](https://vuejs-korea.signup.team/)
- [VueJS Thailand - Facebook 群租](https://www.facebook.com/groups/VuejsThailand/)
- [VueJS Brasil - Telegram 群组 [葡萄牙]](https://t.me/vuejsbrasil)
- [VueJS Brasil - Facebook 主页 [葡萄牙]](https://www.facebook.com/vuejsbrasil/)
- [VueJS Brasil - Facebook 群组 [葡萄牙]](https://www.facebook.com/groups/vuejsbr/)
- [VueJS en español - Facebook 群组 [西班牙]](https://www.facebook.com/groups/vue.es/)
- [VueJS India 🇮🇳  - 嘈杂的聊天服务](https://goo.gl/mYXKUv)
- [VueJS Indonesia - Telegram 群组 [印尼]](https://t.me/vuejsid)
...
- [Vue.js debugging in Chrome and VS Code](https://github.com/Microsoft/vscode-recipes/tree/master/vuejs-cli) 本文介绍如何使用 VS Code 的 Chrome 扩展调试器来调试由 Vue CLI 生成的 Vue.js 应用程序。
